...
export interface FolderScopeSelectorProps {
...
/**
 * Multi-select chip group that lets the user pin a prompt folder to one or
 * more app surfaces. Selecting no chips equals "show in all apps".
 */
export function FolderScopeSelector(props: FolderScopeSelectorProps): React.JSX.Element {
  ...
  return (
    <div>
      ...
      <p className="text-[10.5px] text-muted-foreground/80 mb-2">
        {isAllApps
          ? 'Selecting nothing means this folder shows up in every prompt picker.'
